...
const CourseRegistration: React.FC = () => {
  ...
  const course = "CS"; // Constant course
  ...
  // Fetch Subjects Based on Semester and Result Year
  useEffect(() => {
    const fetchSubjectDetails = async () => {
      ...
      try {
        setLoading(true);
        setError(null);
        const response = await fetch(`/api/subjectlist?semester=${semester}&result_year=${resultYear}`);
        if (!response.ok) {
    ...
    <div className="h-screen bg-white text-black">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex-1 p-8">
          ...
          <div className="flex justify-center gap-6 mb-6">
            ...
            <div>
              ...
              >
                ...
                <option value="2024-01-01">2024-01-06</option>
          ...
          {/* Students and Subjects Tables Horizontally */}
